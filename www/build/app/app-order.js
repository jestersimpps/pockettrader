            ...
            h("ion-content", null,
                h("ion-list", null,
                    ...
                    h("ion-item", { lines: "none" },
                        ...
                        h("ion-label", { "text-right": true, slot: "end" },
                            numeral(this.order.last * this.order.amount - this.order.fee).format('0,0.00000000'),
                            " ",
                            this.order.quote)),
                    h("ion-item", { lines: "none" },
                        h("ion-label", null,
                        ...
                        h("ion-label", { "text-right": true, slot: "end" }, this.order.last ? (h("app-baseprice", { btcPrice: CURRENCYSERVICE.convertToBase(this.order.last * this.order.amount - this.order.openPrice * this.order.amount - 2 * this.order.fee, this.baseCurrency), baseCurrency: this.baseCurrency })) : ('-'))),
