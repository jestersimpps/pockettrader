...
class AppSettings {
    render() {
        return [
            ...
            h("ion-content", null,
                h("ion-list", null,
                    h("ion-item", { lines: "full", href: `/settings/tutorial` },
                        h("ion-icon", { name: "book", "item-start": true, "margin-right": true }),
                        h("ion-label", null, "Tutorial")),
                    ...
                    h("ion-item", { lines: "full", href: `/settings/dust` },
                        h("ion-icon", { name: "eye-off", "item-start": true, "margin-right": true }),
                        h("ion-label", null, "Dust limit")),
