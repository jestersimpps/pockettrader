...
import { b as TICKERSERVICE, c as BALANCESERVICE, e as TRADESERVICE, d as OrderStatus, f as OrderType } from './chunk-811498d8.js';
...
class AppTrade {
    ...
    componentWillLoad() {
        this.store.mapStateToProps(this, (state) => {
            const { app: { exchanges, baseCurrency, currencies, tickers, dust, wallets, orders }, } = state;
            return {
                exchanges,
                baseCurrency,
                currencies,
                ...
                h("ion-list", null,
                    ...
                    this.step === 1 && (h("div", null,
                        ...
                        h("ion-item", { lines: "none" },
                            ...
                            h("ion-label", null,
                                h("ion-button", { size: "small", color: "dark", expand: "block", "text-right": true, onClick: () => (this.tradePrice = this.ticker.last) },
                        ...
                        h("ion-grid", null,
                            h("ion-row", null,
                                h("ion-col", null,
                                    h("ion-button", { expand: "block", color: "danger", onClick: () => this.setPriceWithButtons('--') }, "- -")),
                                h("ion-col", null,
                                    h("ion-button", { expand: "block", color: "danger", onClick: () => this.setPriceWithButtons('-') }, "-")),
                                h("ion-col", null,
                                    h("ion-button", { expand: "block", color: "success", onClick: () => this.setPriceWithButtons('+') }, "+")),
                                h("ion-col", null,
                                    h("ion-button", { expand: "block", color: "success", onClick: () => this.setPriceWithButtons('++') }, "+ +")))))),
                    this.step === 2 && [
                        h("ion-list-header", { color: "light" },
                        ...
                        h("ion-grid", null,
                            h("ion-row", null,
                                h("ion-col", null,
                                    h("ion-button", { expand: "block", color: "success", onClick: () => (this.tradeAction = OrderType.LIMITBUY) }, "Limit Buy")),
                                h("ion-col", null,
                                    h("ion-button", { expand: "block", color: "danger", onClick: () => (this.tradeAction = OrderType.LIMITSELL) }, "Limit Sell")))),
                    ],
                    this.step === 3 && [
                        h("ion-list-header", { color: "light" },
                            h("ion-title", { "text-center": true }, this.isLoading ? (h("ion-icon", { name: "sync", class: "spin" })) : (h("ion-badge", { color: "light" },
                        ...
                        (this.tradeAction === OrderType.LIMITBUY || this.tradeAction === OrderType.MARKETBUY) && (h("ion-item", { lines: "none" },
                            h("ion-label", null,
                                ...
                                this.ticker.quote),
                            h("ion-label", null,
                                h("ion-button", { size: "small", color: "dark", expand: "block", "text-right": true, onClick: () => this.setTradeAmountByButton(1) }, numeral(+this.quoteBalance).format(this.getAmountFormat()))))),
                        (this.tradeAction === OrderType.LIMITSELL || this.tradeAction === OrderType.MARKETSELL) && (h("ion-item", { lines: "none" },
                            h("ion-label", null,
                                "Available ",
                                this.ticker.base),
                            h("ion-label", null,
                                h("ion-button", { size: "small", color: "dark", expand: "block", "text-right": true, onClick: () => this.setTradeAmountByButton(1) }, numeral(+this.baseBalance).format(this.getAmountFormat()))))),
                        h("ion-item", { lines: "full" },
                        ...
                        h("ion-grid", null,
                            h("ion-row", null,
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(0.1) }, "10%")),
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(0.2) }, "20%")),
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(0.3) }, "30%")),
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(0.4) }, "40%")),
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(0.5) }, "50%")),
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(0.6) }, "60%")),
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(0.7) }, "70%")),
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(0.8) }, "80%")),
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(0.9) }, "90%")),
                                h("ion-col", { "col-6": true },
                                    h("ion-button", { expand: "block", color: "light", onClick: () => this.setTradeAmountByButton(1) }, "100%")))),
                    ],
                    this.step === 4 && [
                        h("ion-list-header", { color: "light" },
                            h("ion-title", { "text-center": true },
