...
class Icon {
    ...
    static get style() { return "[data-ion-icon-host] {\n  display: inline-block;\n  font-size: inherit;\n\n  width: 1em;\n  height: 1em;\n\n  contain: strict;\n\n  --ion-color-base: currentColor;\n}\n\n.icon-small[data-ion-icon-host] {\n  font-size: 18px;\n}\n\n.icon-large[data-ion-icon-host]{\n  font-size: 32px;\n}\n\n.icon-inner[data-ion-icon] {\n  font-size: inherit;\n}\n\n.icon-inner[data-ion-icon], svg[data-ion-icon] {\n  height: 100%;\n  width: 100%;\n}\n\nsvg[data-ion-icon] {\n  fill: var(--ion-color-base);\n  stroke: var(--ion-color-base);\n}\n\n\n\n\n.ion-color-primary[data-ion-icon-host] {\n  --ion-color-base: var(--ion-color-primary, #3880ff);\n}\n\n.ion-color-secondary[data-ion-icon-host] {\n  --ion-color-base: var(--ion-color-secondary, #0cd1e8);\n}\n\n.ion-color-tertiary[data-ion-icon-host] {\n  --ion-color-base: var(--ion-color-tertiary, #f4a942);\n}\n\n.ion-color-success[data-ion-icon-host] {\n  --ion-color-base: var(--ion-color-success, #10dc60);\n}\n\n.ion-color-warning[data-ion-icon-host] {\n  --ion-color-base: var(--ion-color-warning, #ffce00);\n}\n\n.ion-color-danger[data-ion-icon-host] {\n  --ion-color-base: var(--ion-color-danger, #f14141);\n}\n\n.ion-color-light[data-ion-icon-host] {\n  --ion-color-base: var(--ion-color-light, #f4f5f8);\n}\n\n.ion-color-medium[data-ion-icon-host] {\n  --ion-color-base: var(--ion-color-medium, #989aa2);\n}\n\n.ion-color-dark[data-ion-icon-host] {\n  --ion-color-base: var(--ion-color-dark, #222428);\n}"; }
}
