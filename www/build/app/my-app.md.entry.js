...
class Tabbar {
    ...
    static get style() { return ".sc-ion-tabbar-md-h {\n  padding-left: var(--ion-safe-area-left);\n  padding-right: var(--ion-safe-area-right);\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  align-items: center;\n  -webkit-box-pack: center;\n  -ms-flex-pack: center;\n  justify-content: center;\n  -webkit-box-ordinal-group: 2;\n  -ms-flex-order: 1;\n  order: 1;\n  width: auto;\n  background: var(--background);\n  color: var(--color);\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n  z-index: 10;\n  -webkit-box-sizing: content-box;\n  box-sizing: content-box; }\n\n.ion-color.sc-ion-tabbar-md-h {\n  --background: var(--ion-color-base);\n  --color: rgba(var(--ion-color-contrast-rgb), 0.7);\n  --color-selected: var(--ion-color-contrast); }\n\n.tabbar-hidden.sc-ion-tabbar-md-h {\n  \n  display: none !important; }\n\n.placement-top.sc-ion-tabbar-md-h {\n  -webkit-box-ordinal-group: 0;\n  -ms-flex-order: -1;\n  order: -1; }\n\n.placement-bottom.sc-ion-tabbar-md-h {\n  padding-bottom: var(--ion-safe-area-bottom, 0); }\n\n.tabbar-highlight.sc-ion-tabbar-md {\n  left: 0;\n  bottom: 0;\n  -webkit-transform-origin: 0 0;\n  transform-origin: 0 0;\n  display: block;\n  position: absolute;\n  width: 1px;\n  height: 2px;\n  -webkit-transform: translateZ(0);\n  transform: translateZ(0);\n  background: currentColor; }\n  .tabbar-highlight.animated.sc-ion-tabbar-md {\n    -webkit-transition-duration: 300ms;\n    transition-duration: 300ms;\n    -webkit-transition-property: -webkit-transform;\n    transition-property: -webkit-transform;\n    transition-property: transform;\n    transition-property: transform, -webkit-transform;\n    -webkit-transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\n    transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\n    will-change: transform; }\n\n.placement-top.sc-ion-tabbar-md-h   .tabbar-highlight.sc-ion-tabbar-md {\n  bottom: 0; }\n\n.placement-bottom.sc-ion-tabbar-md-h   .tabbar-highlight.sc-ion-tabbar-md {\n  top: 0; }\n\n.layout-icon-start.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md {\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n  -ms-flex-direction: row;\n  flex-direction: row; }\n\n.layout-icon-end.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md {\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: reverse;\n  -ms-flex-direction: row-reverse;\n  flex-direction: row-reverse; }\n\n.layout-icon-bottom.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md {\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: reverse;\n  -ms-flex-direction: column-reverse;\n  flex-direction: column-reverse; }\n\n.layout-icon-start.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md, .layout-icon-end.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md, .layout-icon-hide.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md, .layout-label-hide.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md {\n  -webkit-box-pack: center;\n  -ms-flex-pack: center;\n  justify-content: center; }\n\n.layout-icon-hide.sc-ion-tabbar-md-h {\n  --icon-display: none; }\n\n.layout-label-hide.sc-ion-tabbar-md-h {\n  --label-display: none; }\n\n.layout-icon-top.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md, .layout-icon-bottom.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md {\n  --badge-end: calc(50% - 30px); }\n\n.layout-icon-hide.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md, .layout-icon-start.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md, .layout-icon-end.sc-ion-tabbar-md-h   .tab-btn.sc-ion-tabbar-md {\n  --badge-end: calc(50% - 50px); }\n\n.tab-btn.sc-ion-tabbar-md {\n  font-family: inherit;\n  font-size: inherit;\n  font-style: inherit;\n  font-weight: inherit;\n  letter-spacing: inherit;\n  text-decoration: inherit;\n  text-overflow: inherit;\n  text-transform: inherit;\n  text-align: inherit;\n  white-space: inherit;\n  color: inherit;\n  margin: 0;\n  padding: 0;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  position: relative;\n  -webkit-box-flex: 1;\n  -ms-flex: 1;\n  flex: 1;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n  -ms-flex-direction: column;\n  flex-direction: column;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  align-items: center;\n  -webkit-box-pack: start;\n  -ms-flex-pack: start;\n  justify-content: flex-start;\n  width: 100%;\n  height: 100%;\n  border: 0;\n  outline: none;\n  background: transparent;\n  text-decoration: none;\n  cursor: pointer;\n  overflow: hidden;\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box;\n  -webkit-user-drag: none; }\n\n.tab-btn.sc-ion-tabbar-md:focus-visible {\n  background: var(--background-focused); }\n\n\@media (any-hover: hover) {\n  .tab-btn.sc-ion-tabbar-md:hover {\n    color: var(--color-selected); } }\n\n.tab-btn-selected.sc-ion-tabbar-md {\n  color: var(--color-selected); }\n\n.tab-btn-hidden.sc-ion-tabbar-md {\n  \n  display: none !important; }\n\n.tab-btn-disabled.sc-ion-tabbar-md {\n  pointer-events: none;\n  opacity: .4; }\n\n.tab-btn-text.sc-ion-tabbar-md {\n  margin-top: var(--label-margin-top);\n  margin-bottom: var(--label-margin-bottom);\n  display: var(--label-display, block);\n  font-size: var(--label-font-size);\n  line-height: var(--label-line-height); }\n\n.tab-btn-icon.sc-ion-tabbar-md {\n  margin-top: var(--icon-margin-top);\n  margin-bottom: var(--icon-margin-bottom);\n  display: var(--icon-display, block);\n  min-width: var(--icon-min-width);\n  height: var(--icon-height, 1em);\n  font-size: var(--icon-font-size); }\n\n.tab-btn-text.sc-ion-tabbar-md, .tab-btn-icon.sc-ion-tabbar-md {\n  -ms-flex-item-align: center;\n  align-self: center;\n  min-width: 26px;\n  max-width: 100%;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box; }\n\n.tab-btn-has-label-only.sc-ion-tabbar-md   .tab-btn-text.sc-ion-tabbar-md {\n  white-space: normal; }\n\n.tab-btn-has-icon-only.sc-ion-tabbar-md, .tab-btn-has-label-only.sc-ion-tabbar-md {\n  -webkit-box-pack: center;\n  -ms-flex-pack: center;\n  justify-content: center; }\n\n.tab-btn-badge.sc-ion-tabbar-md {\n  right: 4%;\n  top: 6%;\n  right: calc(50% - 30px);\n  padding: 1px 6px;\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box;\n  position: absolute;\n  height: auto;\n  font-size: 12px;\n  line-height: 16px; }\n\n.tab-btn-has-label-only.sc-ion-tabbar-md   .tab-btn-badge.sc-ion-tabbar-md {\n  right: calc(50% - 50px); }\n\n.tab-btn-has-icon-only.sc-ion-tabbar-md   .tab-btn-badge.sc-ion-tabbar-md {\n  right: calc(50% - 30px); }\n\n.tab-btn-selected.sc-ion-tabbar-md   .tab-btn-icon.sc-ion-tabbar-md {\n  -webkit-transform: var(--icon-transform-selected);\n  transform: var(--icon-transform-selected); }\n\n.tab-btn.sc-ion-tabbar-md {\n  padding: 8px 12px 10px 12px;\n  max-width: 168px; }\n\n.tab-btn-text.sc-ion-tabbar-md {\n  margin: 0;\n  -webkit-transform-origin: center bottom;\n  transform-origin: center bottom;\n  -webkit-transform: var(--label-transform);\n  transform: var(--label-transform);\n  -webkit-transition: -webkit-transform 0.1s ease-in-out;\n  transition: -webkit-transform 0.1s ease-in-out;\n  transition: transform 0.1s ease-in-out;\n  transition: transform 0.1s ease-in-out, -webkit-transform 0.1s ease-in-out;\n  text-transform: none; }\n\n.tab-btn-selected.sc-ion-tabbar-md   .tab-btn-text.sc-ion-tabbar-md {\n  -webkit-transform: scale3d(1.16667, 1.16667, 1);\n  transform: scale3d(1.16667, 1.16667, 1);\n  -webkit-transition: -webkit-transform 0.1s ease-in-out;\n  transition: -webkit-transform 0.1s ease-in-out;\n  transition: transform 0.1s ease-in-out;\n  transition: transform 0.1s ease-in-out, -webkit-transform 0.1s ease-in-out; }\n\n.tab-btn-icon.sc-ion-tabbar-md {\n  -webkit-transform-origin: center center;\n  transform-origin: center center;\n  width: 22px;\n  height: 22px;\n  -webkit-transform: var(--icon-transform);\n  transform: var(--icon-transform);\n  -webkit-transition: -webkit-transform 0.1s ease-in-out;\n  transition: -webkit-transform 0.1s ease-in-out;\n  transition: transform 0.1s ease-in-out;\n  transition: transform 0.1s ease-in-out, -webkit-transform 0.1s ease-in-out;\n  font-size: 22px; }\n\n.sc-ion-tabbar-md-h {\n  --color: var(--ion-tabbar-text-color, var(--ion-text-color-step-400, #666666));\n  --color-selected: var(--ion-tabbar-text-color-active, #488aff);\n  --background: var(--ion-tabbar-background-color, #f8f8f8);\n  --background-focused: var(--ion-tabbar-background-color-focused, #dadada);\n  --icon-transform-selected: translate3d(0, -2px, 0);\n  height: 56px;\n  border-top: 1px solid rgba(var(--ion-tabbar-border-color-rgb, 0, 0, 0), 0.07);\n  font-size: 12px;\n  font-weight: normal;\n  contain: strict; }\n\n.layout-icon-top.sc-ion-tabbar-md-h {\n  --label-margin-bottom: -2px; }\n\n.layout-icon-end.sc-ion-tabbar-md-h {\n  --icon-transform-selected: translate3d(6px, 0, 0); }\n\n.layout-icon-bottom.sc-ion-tabbar-md-h {\n  --label-margin-top: -2px;\n  --label-transform: transform-origin(center, top);\n  --icon-transform-selected: translate3d(0, 2px, 0); }\n\n.layout-icon-start.sc-ion-tabbar-md-h {\n  --icon-transform-selected: translate3d(-6px, 0, 0); }"; }
    static get styleMode() { return "md"; }
}
